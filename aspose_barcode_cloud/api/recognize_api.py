...
class RecognizeApi(object):
    ...
    def barcode_recognize_barcode_type_get(self, barcode_type, url, recognition_mode=None, image_kind=None, async_req=False, **kwargs):
        ...
        if async_req:
            return self.barcode_recognize_barcode_type_get_with_http_info(barcode_type, url, recognition_mode=recognition_mode, image_kind=image_kind, **kwargs)
        else:
            (data) = self.barcode_recognize_barcode_type_get_with_http_info(barcode_type, url, recognition_mode=recognition_mode, image_kind=image_kind, **kwargs)
            return data
    ...
    def barcode_recognize_barcode_type_get_with_http_info(self, barcode_type, url, **kwargs):
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method barcode_recognize_barcode_type_get" % key
                )
            if val is None:
                continue
        ...
        if ("barcode_type" not in params or
            ...
            raise ValueError("Missing the required parameter 'barcode_type' when calling 'barcode_recognize_barcode_type_get'")
        ...
        if "image_kind" in params:
            query_params.append(("imageKind", params["image_kind"]))
        ...
        return self.api_client.call_api(
            "/barcode/recognize/{barcodeType}", "GET",
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def barcode_recognize_body_post_with_http_info(self, recognize_base64_request, **kwargs):
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method barcode_recognize_body_post" % key
                )
            if val is None:
                continue
        ...
        if ("recognize_base64_request" not in params or
                params["recognize_base64_request"] is None):
            raise ValueError("Missing the required parameter 'recognize_base64_request' when calling 'barcode_recognize_body_post'")
    ...
    def barcode_recognize_form_post(self, barcode_type, file, recognition_mode=None, image_kind=None, async_req=False, **kwargs):
        """Recognize barcode from file in request body using POST requests with parameters in multipart form.

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = RecognizeApi().barcode_recognize_form_post(barcode_type, file, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if async_req:
            return self.barcode_recognize_form_post_with_http_info(barcode_type, file, recognition_mode=recognition_mode, image_kind=image_kind, **kwargs)
        else:
            (data) = self.barcode_recognize_form_post_with_http_info(barcode_type, file, recognition_mode=recognition_mode, image_kind=image_kind, **kwargs)
            return data

    def barcode_recognize_form_post_with_http_info(self, barcode_type, file, **kwargs):
        """Recognize barcode from file in request body using POST requests with parameters in multipart form.

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = RecognizeApi().barcode_recognize_form_post_with_http_info(barcode_type, file, async_req=True)
        >>> result = thread.get()
        ...
        all_params = { "barcode_type", "file", "recognition_mode", "image_kind" }
        all_params.add("async_req")
        all_params.add("_return_http_data_only")
        all_params.add("_preload_content")
        all_params.add("_request_timeout")
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method barcode_recognize_form_post" % key
                )
            if val is None:
                continue
        ...
        if ("barcode_type" not in params or
                params["barcode_type"] is None):
            raise ValueError("Missing the required parameter 'barcode_type' when calling 'barcode_recognize_form_post'")
        # verify the required parameter "file" is set
        if ("file" not in params or
                params["file"] is None):
            raise ValueError("Missing the required parameter 'file' when calling 'barcode_recognize_form_post'")
