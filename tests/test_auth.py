...
class TestAuth(unittest.TestCase):
    ...
    def test_works_with_access_token(self):
        ...
        response = api.barcode_generate_barcode_type_get(EncodeBarcodeType.QR, EncodeDataType.STRINGDATA, "Testing")
    ...
    def test_unauthorized_raises(self):
        ...
        with self.assertRaises(ApiException) as context:
            api.barcode_generate_barcode_type_get(EncodeBarcodeType.QR, EncodeDataType.STRINGDATA, "Testing")
